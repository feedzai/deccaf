...
if not (os.path.exists('../../Data_and_models/alert_model/best_model.pickle')):
    opt = hpo_fpr.HPO(X_train,X_val,y_train,y_val, method = 'TPE', path = f"../../Data_and_models/alert_model/")
...
deployment.to_parquet('../../Data_and_models/data/BAF_deployment_score.parquet')
...
file_to_store = open("../../Data_and_models/alert_model/model_properties.pickle", "wb")
